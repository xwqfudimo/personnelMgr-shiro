...
<form method="post">
       	菜单名：<input type="text" class="common-text" name="name" id="name" size="16" value="${menu.name }">
       	<br><br>
       	链接：<input type="text" class="common-text" name="href" id="href" size="24" value="${menu.href }">
       	<br><br>
       	排序：<input type="text" class="common-text" name="sort" id="sort" size="3" value="${menu.sort }">
       	<br><br>
...
$(document).ready(function() {
	$("#submit").click(function(e) {
		...
		$.post("${ctxPath }/menu_edit_submit", {'id':id, 'name':name, 'href':href, 'sort':sort}, function(data) {
			if(data == true) {
