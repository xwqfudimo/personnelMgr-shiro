    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
      	...
      	<div class="result-wrap">
            ...
            <form method="post" action="${ctxPath }/yjReport_edit_submit">
                	...
                	<div>
                		...
                		<div class="pxtop"><textarea name="job_summary" class="common-textarea" cols="50">${report.jobSummary }</textarea></div>
                	</div>
                	<br>
